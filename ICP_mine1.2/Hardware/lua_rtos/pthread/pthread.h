...
#define EBUSY           16 //add by lcj keil
#define ETIMEDOUT       138 //add by lcj keil
#define EAGAIN          11 //add by lcj keil
#define ESRCH           3  //add by lcj keil
